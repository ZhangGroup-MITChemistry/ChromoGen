...
def load_ref_genome(chr):
    ...
    ref_path = '/home/gridsan/groups/binz_group/gkks/with_Zhuohan/sequence_data/hg19/'
...
def load_hic(cl, chr):
    ...
    hic_path = '/home/gridsan/groups/binz_group/gkks/with_Zhuohan/HiC_from_Zhuohan/'
...
#    hic_data={}
    ...
    #dnase_path = '/home/gridsan/groups/binz_group/gkks/with_Zhuohan/sequence_data/'
    from pathlib import Path
    dnase_path = Path(__file__).parent.parent.parent/'outside_data/sequence_data/DNase_seq/hg19/GM12878.pkl'
    #with open(dnase_path + 'GM12878_hg19.pkl', 'rb') as f:
    with dnase_path.open('rb') as f:
        dnase = pickle.load(f)
    for chr in chrs:
        if chr != 'X':
