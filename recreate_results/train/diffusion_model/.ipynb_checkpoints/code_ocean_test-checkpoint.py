...
#SBATCH --array=0#-7
#SBATCH --output=./log_files/code_ocean_test.log #origami_64_no_embed_reduction_full_scan_IMR_%a.log
...
save_dir_2D = '../../data/samples/GM/full_scan_raw_output/'
save_dir_3D = '../../data/samples/GM/full_scan/'
#save_dir_2D = '/results/samples/GM/full_scan_raw_output/'
#save_dir_3D = '/results/samples/GM/full_scan/'
...
for chrom in regions:
    ...
    for region in regions[chrom]:
        ...
        for cond_scale, rescaled_phi in cond_scales_phis:
...
#################################################################################
# Specific regions
num_samples = 10#_000 # per guidance strength

# Choose directories to save data to 
save_dir_2D = '../../data/samples/GM/other_regions_raw_output/'
save_dir_3D = '../../data/samples/GM/other_regions/'
#save_dir_2D = '/results/samples/GM/other_regions_raw_output/'
#save_dir_3D = '/results/samples/GM/other_regions/'
