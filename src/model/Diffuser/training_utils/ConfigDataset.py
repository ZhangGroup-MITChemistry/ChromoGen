...
class ConfigDataset:
    ...
    def __init__(
        ...
        self.remove_diagonal = remove_diagonal #NOTE: Only validated for the fetch function
    ...
    def fetch_specific_coords(
        ...
        start_idx,       # Integer representing the starting position within the chromosome (in bp) 
        *, 
    ...
    def fetch(self,start_indices):
        ...
        b,c,h = dists.shape[0],dists.shape[1],self.seg_len-int(self.remove_diagonal)
