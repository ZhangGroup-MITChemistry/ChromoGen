...
#SBATCH --job-name=train_origami_64_experimental_hic #train_origami_64_resnet_like
##SBATCH --partition=debug-gpu
#SBATCH --gres=gpu:volta:1
#SBATCH -c 20
##SBATCH -t 0-0:05
##SBATCH -t 0-65:00:00
#SBATCH --output=./log_files/train_origami_64_experimental_hic.log
...
unet = Unet(
    ...
    attn_dim_head = 32,
    attn_heads = 4,
    embedding_dimensions=(1,1,segment_length*(segment_length+1)//2),
