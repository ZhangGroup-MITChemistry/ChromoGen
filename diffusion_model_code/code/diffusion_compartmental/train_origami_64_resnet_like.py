...
#SBATCH --job-name=train_origami_64_resnet_like
##SBATCH --partition=debug-gpu
#SBATCH --gres=gpu:volta:1
#SBATCH -c 20
##SBATCH -t 0-0:05
##SBATCH -t 0-36:00:00
#SBATCH --output=./log_files/train_origami_64_resnet_like.log
...
save_folder = '../../data/models/diffusion_origami_64_resnet_like'#'./results_small'
...
from Unet_resnet_like import Unet
