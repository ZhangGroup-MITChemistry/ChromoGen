...
#SBATCH --job-name=train_origami_126_no_embed_reduction #train_origami_64_resnet_like
##SBATCH --partition=debug-gpu
#SBATCH --gres=gpu:volta:1
#SBATCH -c 20
##SBATCH -t 0-0:05
##SBATCH -t 0-65:00:00
#SBATCH --output=./log_files/train_origami_126_no_embed_reduction.log
...
save_folder = '../../data/models/diffusion_origami_126_no_embed_reduction'
...
from Trainer_double_origami import Trainer
...
from DataLoader_peel_edge import DataLoader
