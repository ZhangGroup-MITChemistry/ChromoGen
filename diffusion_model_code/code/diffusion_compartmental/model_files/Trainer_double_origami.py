...
from OrigamiTransform import OrigamiTransform
origami_transform = origami_transform = OrigamiTransform(num_reduction_steps=2,drop_lower_triangle=True,preserve_diagonal=False)
...
class Trainer(object):
    ...
    def load(self, milestone):
        # Trying to reduce memory usage for the larger model to load correctly 
        # Basically, I don't even use the ema_model anymore, so just avoid it (saves a TON of space)
        accelerator = self.accelerator
