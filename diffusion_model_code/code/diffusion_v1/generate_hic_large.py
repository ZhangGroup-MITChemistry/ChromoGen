...
#SBATCH --job-name=generate_hic
##SBATCH --partition=debug-gpu
#SBATCH --gres=gpu:volta:1
#SBATCH -c 20
#SBATCH -t 0-3:00:00
##SBATCH -t 0-36:00:00
#SBATCH --output=./log_files/generate_hic_large.log
...
fp = './results_large/model-11.pt'#'./results/model-120.pt'
...
fig.savefig('./results_large/hic_map.png')

import pickle
pickle.dump({'sample':sample,'hic_map':hic_map,'fig':fig},open('./results_large/generated_hic_map.pkl','wb'))
