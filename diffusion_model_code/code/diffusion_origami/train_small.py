...
save_folder = '../../data/models/diffusion_small_origami'#'./results_small'
...
segment_length = 64
batch_size = 128#64 # Trained with batch_size==64 for 600,000 iterations, then switched to batch_size==128 for another 600,000
shuffle_data = True
...
trainer = Trainer(
    ...
    train_lr = 1e-4,
    train_num_steps = 1_200_000,#600000,
    ema_update_every = 10,
    ema_decay = 0.995,
    adam_betas = (0.9, 0.99),
