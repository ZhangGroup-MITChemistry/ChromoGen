...
#SBATCH --job-name=train_small_origami_larger_embedder
##SBATCH --partition=debug-gpu
#SBATCH --gres=gpu:volta:1
#SBATCH -c 20
##SBATCH -t 0-0:05
##SBATCH -t 0-36:00:00
#SBATCH --output=./log_files/train_small_larger_embedder.log
...
save_folder = '../../data/models/diffusion_small_origami_larger_embedder'#'./results_small'
...
from classifier_free_guidance_greg_larger_embedder import GaussianDiffusion, Unet, Trainer
...
trainer = Trainer(
    ...
    gradient_accumulate_every = 2, # Using 2 here instead of 1 keeps the effective batch size the same as in other training schemes
