...
##SBATCH -t 0-0:05
##SBATCH -t 0-36:00:00
#SBATCH --output=./log_files/train_large.log
...
save_folder = '../../data/models/diffusion_large'#'./results_large'
...
#pickle.dump(dl.index['Chromosome'].unique().tolist(),open('./results_large/chroms.pkl','wb'))
###########################################################
