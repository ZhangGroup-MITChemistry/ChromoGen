...
#SBATCH --job-name=generate_hic_small_larger_embedder
##SBATCH --partition=debug-gpu
#SBATCH --gres=gpu:volta:1
#SBATCH -c 20
##SBATCH -t 0-3:00:00
##SBATCH -t 0-36:00:00
#SBATCH --output=./log_files/generate_hic_small_larger_embedder.log
...
from classifier_free_guidance_greg_larger_embedder import GaussianDiffusion, Unet
...
milestone = 84 #120#37#69
#fp = f'./results_small/model-{milestone}.pt'
fp = f'../../data/models/diffusion_small_large_embedder/model-{milestone}.pt'
save_folder = '../../data/samples/small_model_large_embedder/'
...
diffusion.eval()
n=0 
cond_scales = [4,5,6]#[1.,2.,4.,6.,8.]
rescaled_phis = [0,.25,.5,.75,1]#[0.,.25,.5,.75,1.]
