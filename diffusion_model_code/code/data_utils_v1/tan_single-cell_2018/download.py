'''
Use to download data. Should probably make this a callable function later, and probably also add functionality that prevents unneeded supplementary files from being downloaded. 
'''
...
accession = "GSE117876"
destdir = '../../../data/tan_single-cell_2018/'
...
gse.download_supplementary_files(directory=destdir,nproc=nproc)
