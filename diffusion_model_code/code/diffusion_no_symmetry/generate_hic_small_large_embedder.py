...
#SBATCH --job-name=generate_hic_small_large_embed
##SBATCH --partition=debug-gpu
#SBATCH --gres=gpu:volta:1
#SBATCH -c 20
##SBATCH -t 0-3:00:00
##SBATCH -t 0-36:00:00
#SBATCH --output=./log_files/generate_hic_small_large_embed.log
...
milestone = 95 #120#37#69
#fp = f'./results_small/model-{milestone}.pt'
fp = f'../../data/models/diffusion_no_symmetry_32_larger_embedder/model-{milestone}.pt'
save_folder = '../../data/samples/no_symmetry_32_larger_embedder/'
