...
#SBATCH --job-name=train_small_larger_embedder
##SBATCH --partition=debug-gpu
#SBATCH --gres=gpu:volta:1
#SBATCH -c 20
##SBATCH -t 0-0:05
##SBATCH -t 0-36:00:00
#SBATCH --output=./log_files/train_larger_embedder.log
...
save_folder = '../../data/models/diffusion_no_symmetry_32_larger_embedder'#'./results_small'
