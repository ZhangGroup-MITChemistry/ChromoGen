...
#SBATCH --job-name=origami_64_no_embed_reduction_full_scan
##SBATCH --partition=debug-gpu
#SBATCH --ntasks=1 # Per NODE
#SBATCH --gres=gpu:volta:1  # Per NODE
#SBATCH --cpus-per-task=20  # Per TASK
#SBATCH --array=0-7
#SBATCH --output=./log_files/origami_64_no_embed_reduction_full_scan_%a.log
...
save_dir_2D = '../../data/samples/origami_64_no_embed_reduction/full_scan/'
save_dir_3D = '../../data/samples/origami_64_no_embed_reduction/full_scan/corrected/'
