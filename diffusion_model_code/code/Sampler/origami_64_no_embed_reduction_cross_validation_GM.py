...
#SBATCH --job-name=origami_64_no_embed_reduction_cross_validation_GM_CTCF
##SBATCH --partition=debug-gpu
#SBATCH --ntasks=1 # Per NODE
#SBATCH --gres=gpu:volta:1  # Per NODE
#SBATCH --cpus-per-task=20  # Per TASK
#SBATCH --array=0-2
#SBATCH --output=./log_files/origami_64_no_embed_reduction_cross_validation_GM_CTCF_%a.log
...
regions = { # chrom:region_idxs
    #'11':[2000,2005,2020,2040,2060], # Regions with differences
    '3':[91] # Region with CTCF flip 
}
