...
#SBATCH --job-name=origami_64_no_embed_reduction_active_inactive_repressed
##SBATCH --partition=debug-gpu
#SBATCH --ntasks=1 # Per NODE
#SBATCH --gres=gpu:volta:1  # Per NODE
#SBATCH --cpus-per-task=20  # Per TASK
#SBATCH --array=0-7
#SBATCH --output=./log_files/origami_64_no_embed_reduction_active_inactive_repressed_%a.log
...
regions = {
    '1':[1123, 1644, 1476, 1652, 1679, 1175, 1082, 1459], # Repressed regions
    '21':[
        1000,691,824,696,1264,692,1263,#1263, # Active regions
        922,613,870,875,628,759,861,498       # Inactive regions
    ]
}
...
save_dir = '../../data/samples/origami_64_no_embed_reduction/active_inactive_repressed/'
