...
#SBATCH --job-name=origami_64_no_embed_reduction_cross_validation_v2
##SBATCH --partition=debug-gpu
#SBATCH --ntasks=1 # Per NODE
#SBATCH --gres=gpu:volta:1  # Per NODE
#SBATCH --cpus-per-task=20  # Per TASK
#SBATCH --array=0-1 #5
#SBATCH --output=./log_files/origami_64_no_embed_reduction_cross_validation_%a_v2.log
...
rescaled_phis = [.5]
'''
cond_scales = [5.]#[2.5]#[1.5,2.,2.5,3.,3.5,4.]
rescaled_phis = [8.]#[.5]#[.1,.3,.5,.7,.9]
...
folders = [
    ...
    (
        '/home/gridsan/gschuette/refining_scHiC/revamp_with_zhuohan/data/cross_validation_embeddings/GM/',
        '/home/gridsan/gschuette/refining_scHiC/revamp_with_zhuohan/data/samples/origami_64_no_embed_reduction/cross_validation/GM/'
    )
]
