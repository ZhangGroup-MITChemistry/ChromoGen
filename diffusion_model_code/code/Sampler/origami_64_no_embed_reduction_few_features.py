...
#SBATCH --job-name=origami_64_no_embed_reduction_few_features
##SBATCH --partition=debug-gpu
#SBATCH --ntasks=1 # Per NODE
#SBATCH --gres=gpu:volta:1  # Per NODE
#SBATCH --cpus-per-task=20  # Per TASK
#SBATCH --array=0-2
#SBATCH --output=./log_files/origami_64_no_embed_reduction_few_features_%a.log
...
cond_scales = [5.0] #[1.5,2.,2.5,3.,3.5,4.]
