...
#SBATCH --job-name=origami_64_no_embed_reduction_interesting_regions_IMR_5
##SBATCH --partition=debug-gpu
#SBATCH --ntasks=1 # Per NODE
#SBATCH --gres=gpu:volta:1  # Per NODE
#SBATCH --cpus-per-task=20  # Per TASK
#SBATCH --array=0-3 #5
#SBATCH --output=./log_files/origami_64_no_embed_reduction_interesting_regions_IMR_5_%a.log
...
regions = {
    ...
    '20':[15,186],
    '22':[464,675],
    'X':[100,236,381,445,553,610,675,810,900,965,1060,1125,1200,4756] # for high K27 content
}

# Regions shown in paper
regions = {
    '1':[395,1325],
    '2':[3993],
    '5':[1618],
...
embedding_file = lambda chrom: f'../../data/embeddings_64_IMR/chrom_{chrom}.tar.gz'
save_dir = '../../data/samples/origami_64_no_embed_reduction/cross_validation/IMR/'
