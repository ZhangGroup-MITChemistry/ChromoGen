...
#SBATCH --job-name=origami_64_no_embed_reduction_unguided
##SBATCH --partition=debug-gpu
#SBATCH --ntasks=1 # Per NODE
#SBATCH --gres=gpu:volta:1  # Per NODE
#SBATCH --cpus-per-task=20  # Per TASK
#SBATCH --array=0-1
#SBATCH --output=./log_files/origami_64_no_embed_reduction_unguided_%a.log
...
save_file = f'../../data/samples/origami_64_no_embed_reduction/eval_mode/unguided_{array}.pt'
