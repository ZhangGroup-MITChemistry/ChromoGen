...
#SBATCH --job-name=origami_64_no_embed_reduction_interesting_regions_IMR
##SBATCH --partition=debug-gpu
#SBATCH --ntasks=1 # Per NODE
#SBATCH --gres=gpu:volta:1  # Per NODE
#SBATCH --cpus-per-task=20  # Per TASK
#SBATCH --array=0-3 #5
#SBATCH --output=./log_files/origami_64_no_embed_reduction_interesting_regions_IMR_%a.log
