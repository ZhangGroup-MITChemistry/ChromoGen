...
for chrom_name,chroms_to_include in [
    ('X',['X']),
    ('no_X',[str(k) for k in range(1,23)])
]:
    ...
    for cell_type,files,exp_hic in [
        ...
        data_fp_ = data_fp(cell_type + '_' + chrom_name)
        ...
        for fraction_w1 in fractions:
            ...
            for f in tqdm(files):
                ...
                # Avoid looking at the same region twice
                if '1.0_0.0' not in f:
                    continue
                ...
                if chrom not in chroms_to_include:
                    continue
                ...
                if cell_type == 'Tan':
                    ...
                    coords1 = coords1.append(coords2) # just append them since we generated them in the proper ratio
