...
#SBATCH --array=0-95
#SBATCH --output=./log_files/RMSD_compute_chrom_22_%a.log
...
tan_coords = gen_coords[0].append(tan_coords[1:])
...
with tqdm(initial=0,total=N) as pbar:
    for option in ['gen_on_gen','tan_on_tan','tan_on_gen','gen_on_tan']:
        ...
        torch.save( rmsd_values, save_folder + f'{option}_chrom_22_{task_id}.pt' )
